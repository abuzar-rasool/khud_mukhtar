    ...
    return ClipRRect(
      ...
      child: new Scaffold(
        ...
        appBar: new AppBar(
          ...
          iconTheme: new IconThemeData(color: Colors.pink[300]),
          title: Text('GIVE YOUR RATING',style: TextStyle(color: pink300),),
        ),
        body: new Column(
          children: <Widget>[
            new Expanded(
                ...
                child: Container(
                  ...
                  child:  Center(
                    child: Text(
                        ...
                        style: TextStyle(fontSize: 20,color: pink300,fontWeight: FontWeight.bold)
                    ),
                  ),
                ),
              ),
...
class Points extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double newPoints=double.parse((((points/100)*5)).toStringAsFixed(1));
    return Row(
      crossAxisAlignment:
        ...
        new Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              new Text(isPointsYouNeed ? 'DEDUCTED' : 'GIVEN',
                  style:
                  new TextStyle(fontWeight: FontWeight.bold, color: color))
            ],
          ),
